...
rlining_and_demographics <- leaflet() %>%
  ...
  addPolygons(group = "Black Population",
              ...
              smoothFactor = 0.2,
              fillOpacity = 0.5,
              label = paste("Percent Black:",(balt_race_percentages_join$percent_black), "for",balt_race_percentages_join$neighborhood)) %>%
  addPolygons(group = "White Population",
              ...
              smoothFactor = 0.2,
              fillOpacity = 0.5,
              label = paste("Percent White:",(balt_race_percentages_join$percent_white), "for",balt_race_percentages_join$neighborhood)) %>%
  addPolylines(
