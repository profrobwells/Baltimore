...
#  0.3353  0.4444  0.4556  0.4613  0.4752  0.5241       1 

median(smith$nbanks_zip, na.rm = TRUE) #5
summary(smith$nbanks_zip, na.rm = TRUE) 
  # Min. 1st Qu.  Median    Mean 3rd Qu.    Max.    NA's 
  # 0.000   2.000   5.000   5.869   8.000  14.000       1 
...
smith2 <- read_csv("smith1_balt.csv")
...
```{r}
#communities with greater than median membership - 46%- but less than median income - $22,654
smith2 %>% 
